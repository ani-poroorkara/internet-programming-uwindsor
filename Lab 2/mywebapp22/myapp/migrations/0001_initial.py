    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hours', models.CharField(blank=True, max_length=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('0', 'Cancelled'), ('1', 'Order Confirmed')], default='1', max_length=20)),
                ('order_date', models.DateTimeField(auto_now=True)),
                ('Student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course', to='myapp.student')),
